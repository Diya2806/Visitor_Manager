...
class Rental : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            val menu = findViewById<ImageView>(R.id.menu_rental)
            ...
            if (id != null) {
                ...
                val name = findViewById<TextView>(R.id.rentname)
            ...
            logout.setOnClickListener(){
                ...
                val loginIntent = Intent(this@Rental, Login_Page::class.java)
